...
func TestGetDigestURL(t *testing.T) {
	tests := []struct {
		...
		{"nginx", "https://registry.hub.docker.com/v2/library/nginx/manifests/latest"},
		{"index.docker.io/library/nginx", "https://registry.hub.docker.com/v2/library/nginx/manifests/latest"},
